...
class CountryAdmin(admin.ModelAdmin):
    list_display = ["name", "code", "availability_status", "display_order", "updated_at"]
...
class InstitutionAdmin(admin.ModelAdmin):
    list_display = ["name", "country", "institution_type", "availability_status", "updated_at"]
...
class CampusAdmin(admin.ModelAdmin):
    list_display = ["name", "institution", "city", "availability_status", "updated_at"]
    list_filter = ["availability_status"]
    search_fields = ["name", "city", "institution__name"]
    readonly_fields = ["id", "created_at", "updated_at"]
